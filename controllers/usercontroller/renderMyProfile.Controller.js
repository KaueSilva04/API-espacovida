const renderProfile = require('../../services/userservices/renderMyProfile.Service')

module.exports = {
    async renderMyProfile(req, res) {
        try {
            const token = req.cookies.token;
            const user = await renderProfile.renderMyProfileService(token);
